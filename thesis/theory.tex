...
Interesting results have been found in a study by Sjøberg et. al
\cite{sjoberg2013quantifying} where certain bad design choices (or \textit{code
smells}) was hypothesized to lead to a greater maintenance effort. However, the
best predictor of maintenance effort turned out to be code size and number of
revisions of the software. I.e. small code bases are easier to maintain.
...
similar result. Benestad et. al. \cite{benestad2006assessing} applied several
...
and \textit{interpretation}, which are explained further
\cite{benestad2006assessing}.
