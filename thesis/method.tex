...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}[node distance=5cm, auto, >=stealth']
        ...
        \node[below of=brewer, node distance=8cm] (brewer_ground) {};
        \node[below of=barista, node distance=8cm] (barista_ground) {};
        \node[below of=customers, node distance=8cm] (customers_ground) {};
        ...
        \draw[<-] ($(barista)!1cm!(barista_ground)$) --
            node[above, scale=0.9, midway]{$Order_0$}
        ...
        \draw[->] ($(barista)!2cm!(barista_ground)$) --
            node[above, scale=0.9, midway]{Return $Order_0$}
        ...
        \draw[<-] ($(barista)!3cm!(barista_ground)$) --
            node[above, scale=0.9, midway]{$Order_1$}
        ...
        \draw[->] ($(barista)!4cm!(barista_ground)$) --
            node[above, scale=0.9, midway]{Return $Order_1$}
        ...
        \draw[<-] ($(barista)!6cm!(barista_ground)$) --
            node[above, scale=0.9, midway]{$Order_{m-1}$}
        ...
        \draw[->] ($(barista)!7cm!(barista_ground)$) --
            node[above, scale=0.9, midway]{Return $Order_{m-1}$}
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}[node distance=3cm, auto, >=stealth']
        ...
        \node[below of=brewern, node distance=8cm] (brewern_ground) {};
        \node[below of=baristan, node distance=8cm] (baristan_ground) {};
        \node[below of=dots, node distance=8cm] (dots_ground) {};
        \node[below of=brewer0, node distance=8cm] (brewer0_ground) {};
        \node[below of=barista0, node distance=8cm] (barista0_ground) {};
        \node[below of=customers, node distance=8cm] (customers_ground) {};
        ...
        \draw[<-, dashed] ($(dots)!2cm!(dots_ground)$) --
            node[above, scale=0.9, pos=0.4]{$Order_1$}
            ($(customers)!2cm!(customers_ground)$);
        ...
        \draw[->, dashed] ($(dots)!5.5cm!(dots_ground)$) --
            node[above, scale=0.9, pos=0.41]{Return $Order_{m-2}$}
